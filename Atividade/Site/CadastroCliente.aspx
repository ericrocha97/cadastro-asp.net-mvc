        ...
        <div class="form-group  ">
            ...
            <div class="input-group mb-3">
                 <div class="input-group-prepend">
                    ...
                    <asp:TextBox ID="TextBoxEndereco" runat="server" class="form-control" required="required"></asp:TextBox> <br />
             </div>
            <div class="input-group mb-3">
                 <div class="input-group-prepend">
                    <span class="input-group-text">Cidade</span>
                 </div>
                    <asp:TextBox ID="TextBoxCidade" runat="server" class="form-control" required="required"></asp:TextBox> <br />
             </div>
        </div>
        ...
        <div class="row" style="width: 100%;">  
            ...
            <div class="col-sm-6">
                ...
                <div style="margin-left: 20px;">
                    <asp:GridView ID="GridCliente" runat="server" AutoGenerateColumns="false" class="table table-striped table-dark">
                        <Columns>        
